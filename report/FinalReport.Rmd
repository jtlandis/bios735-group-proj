...
Below is a plot of mean sales of products for each brand, transformed to a log-scale. We can qualitatively see that as the proportion of brand-specific items on promotion increases, as does the quantity sold, in general. We will further investigate these within-brand trends.
...
We can also observe the within-brand correlation via the heatmap below. It is of particular interest that brands 3 and 4 have increased correlation, as evident by the bright color sections in the last two blocks of the diagonal. 
