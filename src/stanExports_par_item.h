...
namespace model_par_item_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 47> locations_array__ =
  {" (found before start of program)",
  " (in 'par_item', line 20, column 2 to column 18)",
  " (in 'par_item', line 21, column 2 to column 24)",
  " (in 'par_item', line 22, column 2 to column 29)",
  " (in 'par_item', line 27, column 2 to column 36)",
  " (in 'par_item', line 50, column 2 to column 28)",
  " (in 'par_item', line 52, column 4 to column 21)",
  " (in 'par_item', line 54, column 6 to column 36)",
  " (in 'par_item', line 53, column 19 to line 55, column 5)",
  " (in 'par_item', line 53, column 4 to line 55, column 5)",
  " (in 'par_item', line 56, column 4 to column 50)",
  " (in 'par_item', line 57, column 4 to column 52)",
  " (in 'par_item', line 58, column 4 to column 46)",
  " (in 'par_item', line 51, column 27 to line 59, column 3)",
  " (in 'par_item', line 51, column 2 to line 59, column 3)",
  " (in 'par_item', line 33, column 2 to column 46)",
  " (in 'par_item', line 34, column 2 to column 27)",
  " (in 'par_item', line 35, column 2 to column 32)",
  " (in 'par_item', line 38, column 4 to column 21)",
  " (in 'par_item', line 40, column 6 to column 36)",
  " (in 'par_item', line 39, column 19 to line 41, column 5)",
  " (in 'par_item', line 39, column 4 to line 41, column 5)",
  " (in 'par_item', line 42, column 4 to column 50)",
  " (in 'par_item', line 43, column 4 to column 52)",
  " (in 'par_item', line 44, column 4 to column 24)",
  " (in 'par_item', line 37, column 27 to line 45, column 3)",
  " (in 'par_item', line 37, column 2 to line 45, column 3)",
  " (in 'par_item', line 5, column 2 to column 21)",
  " (in 'par_item', line 6, column 2 to column 17)",
  " (in 'par_item', line 7, column 2 to column 17)",
  " (in 'par_item', line 8, column 8 to column 13)",
  " (in 'par_item', line 8, column 2 to column 30)",
  " (in 'par_item', line 9, column 9 to column 14)",
  " (in 'par_item', line 9, column 16 to column 17)",
  " (in 'par_item', line 9, column 2 to column 21)",
  " (in 'par_item', line 11, column 9 to column 10)",
  " (in 'par_item', line 11, column 2 to column 21)",
  " (in 'par_item', line 12, column 13 to column 14)",
  " (in 'par_item', line 12, column 2 to column 28)",
  " (in 'par_item', line 13, column 9 to column 10)",
  " (in 'par_item', line 13, column 2 to column 18)",
  " (in 'par_item', line 14, column 2 to column 22)",
  " (in 'par_item', line 15, column 2 to column 22)",
  " (in 'par_item', line 20, column 9 to column 10)",
  " (in 'par_item', line 21, column 10 to column 11)",
  " (in 'par_item', line 27, column 9 to column 10)",
  " (in 'par_item', line 50, column 9 to column 18)"};
#include <stan_meta_header.hpp>
class model_par_item final : public model_base_crtp<model_par_item> {
private:
  int T_obs;
  int q;
  int p;
...
public:
  ~model_par_item() {}
  model_par_item(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_par_item_namespace::model_par_item";
    // suppress unused var warning
    (void) function__;
    ...
    num_params_r__ = p + (q - 1) + 1;
  }
  inline std::string model_name() const final {
    return "model_par_item";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_par_item_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_par_item_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"gamma", "beta_tilde", "tau"};
    if (emit_transformed_parameters__) {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"gamma\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(p) + "},\"block\":\"parameters\"},{\"name\":\"beta_tilde\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(q) + "},\"block\":\"parameters\"},{\"name\":\"tau\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(q) + "},\"block\":\"transformed_parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(log_lik_1dim__) + "},\"block\":\"generated_quantities\"}]");
  }
  inline std::string get_unconstrained_sizedtypes() const {
    return std::string("[{\"name\":\"gamma\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(p) + "},\"block\":\"parameters\"},{\"name\":\"beta_tilde\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string((q -1)) + "},\"block\":\"parameters\"},{\"name\":\"tau\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(q) + "},\"block\":\"transformed_parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(log_lik_1dim__) + "},\"block\":\"generated_quantities\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = ((p + q) + 1);
...
using stan_model = model_par_item_namespace::model_par_item;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_par_item_namespace::profiles__;
}
#endif
#endif
