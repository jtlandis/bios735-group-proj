...
#include "stanExports_par_item_intercept.h"

RCPP_MODULE(stan_fit4par_item_intercept_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_par_item_intercept")
